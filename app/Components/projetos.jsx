  ...
  return (
    <section class="text-gray-600 body-font" id='projetos'>
        ...
        <FadeInOnScroll>
            ...
            <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Desde designs atraentes até sistemas funcionais, nossos projetos refletem uma mistura única de criatividade e inovação. Cada projeto conta uma história autêntica de colaboração, visão e sucesso conjunto.</p>
            </div>
            ...
            <div class="xl:w-1/4 md:w-1/2 p-4">
                ...
                <a href='#' class="mt-3 text-blue-500 inline-flex items-center">Ver site
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                    </svg>
                </a>
