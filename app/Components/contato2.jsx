...
const ContatoProvisorio = () => {
  return (
   <div class="p-2 w-full pt-8 mt-2 text-center" id='contato'>
    <div class='mb-4'>
        ...
        <p class="leading-normal my-2">Vitor e Henrique,
...
export default ContatoProvisorio