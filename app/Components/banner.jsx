...
const Banner = () => {
  return (
    <section id='home' className="bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${BannerImage.src})`, height: '70vh'}}>   
      <div className="container mx-auto flex h-full px-5 items-center justify-center flex-col text-white">
        <div className="text-center lg:w-2/3 w-full">
          <FadeInOnScroll>
            <div className="text-center">
              <h1 className="title-font sm:text-3xl text-3xl mb-4 font-medium text-white">DESENVOLVENDO SOLUÇÕES DIGITAIS INOVADORAS PARA O SEU NEGÓCIO!</h1>
